<%@ Page Title="" Language="C#" MasterPageFile="~/RepairShop.Master" AutoEventWireup="true" CodeBehind="UpdateRepairShop.aspx.cs" Inherits="AAMPCRUDD.UpdateRepairShop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" Text="Update Repair Shop" CssClass="btn btn-info" OnClick="Button1_Click" />
        </form>
